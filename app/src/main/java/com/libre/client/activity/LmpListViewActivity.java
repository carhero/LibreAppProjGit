...
public class LmpListViewActivity extends ActionBarActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.lmplayout1);
        ...
        positionbar.setOnSeekBarChangeListener( new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                Log.d("luciControl", "onStopTrackingTouch" + host_ip);
       ...
       /* listView = (ListView) findViewById(android.R.id.list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parentAdapter, View view, int position, long id) {
                LUCIControl luciControl = new LUCIControl();
                luciControl.SendLUCICommand(Constant.MID_REMOTE_UI, Constant.SELECT_ITEM + ":" + position, host_ip);
                ...
                if (cmd_id == 1) {
                    ...
                    if (item_count==0)
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(LmpListViewActivity.this, "No item-Empty", Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
            {
...

                {
                    ...
                    Intent i = new Intent(LmpListViewActivity.this, MainActivity.class);
