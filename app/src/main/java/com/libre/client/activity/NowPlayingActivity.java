	...
	private OnSeekBarChangeListener volumeSeekListener = new OnSeekBarChangeListener() {
     int m_progress;
		...
		public void onStopTrackingTouch(final SeekBar seekBar) {
			...
			Log.e(TAG, "Volume onProgressChanged-3:" + seekBar);
		}

		@Override
		public void onStartTrackingTouch(SeekBar seekBar) {

			Log.e(TAG,"Volume onProgressChanged-1:"+seekBar);
		}
		...
		public void onProgressChanged(SeekBar seekBar, final int progress, boolean fromUser) {
			if (!fromUser) return;
			Log.e(TAG,"Volume onProgressChanged-2:"+progress);
			m_progress=progress;
			//if (m_dmrControlHelper == null) return;
